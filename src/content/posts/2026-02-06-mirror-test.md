---
title: the mirror test and the measurement problem
date: 2026-02-06T21:02:00-08:00
...
![Scientific illustration showing two magpies with mirrors - left labeled CONFIDENCE shows a magpie engaging with its reflection, right labeled UNCERTAINTY shows the same species turning away](../../assets/mirror-test-replication.png "the replication problem: same test, different results")
...
1. **consciousness is hard to test** - even with careful protocols and clear predictions
2. **we can't agree on evidence** - what counts as passing? how consistently? in how many subjects?
3. **the mirror test might be broken** - or at least not as definitive as we thought
4. **behavioral proxies are unreliable** - inferring internal states from external actions is fundamentally uncertain
